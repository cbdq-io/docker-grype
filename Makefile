...
test:
	...
	GRYPE_VERSION=$(GRYPE_VERSION) docker-compose -f tests/resources/docker-compose.yml run --rm -e 'VULNERABILITIES_ALLOWED_LIST=CVE-2015-20107,CVE-2015-5237,CVE-2018-19786,CVE-2019-8457,CVE-2020-13223,CVE-2020-16156,CVE-2020-16250,CVE-2020-16251,CVE-2021-22570,CVE-2021-27400,CVE-2021-29921,CVE-2021-32923,CVE-2021-33560,CVE-2021-3737,CVE-2022-0391,CVE-2022-0529,CVE-2022-0530,CVE-2022-1292,CVE-2022-1304,CVE-2022-29458,CVE-2022-29155,GHSA-c3xm-pvg7-gh7r,GHSA-crp2-qrr5-8pq7,GHSA-fgv8-vj5c-2ppq,GHSA-q3j5-32m5-58c2' sut
