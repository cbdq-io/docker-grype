...
test:
	...
	GRYPE_VERSION=$(GRYPE_VERSION) ONLY_FIXED=1 docker-compose -f tests/resources/docker-compose.yml run --rm -e 'VULNERABILITIES_ALLOWED_LIST=GHSA-8v99-48m9-c8pm,GHSA-c3xm-pvg7-gh7r,GHSA-crp2-qrr5-8pq7,GHSA-fgv8-vj5c-2ppq,GHSA-q3j5-32m5-58c2' sut
	GRYPE_VERSION=$(GRYPE_VERSION) docker-compose -f tests/resources/docker-compose.yml run --rm -e 'VULNERABILITIES_ALLOWED_LIST=CVE-2015-20107,CVE-2015-5237,CVE-2020-16156,CVE-2021-22570,CVE-2021-29921,CVE-2021-33560,CVE-2021-3737,CVE-2022-0391,CVE-2022-0529,CVE-2022-0530,CVE-2022-1304,CVE-2022-21698,CVE-2022-24778,CVE-2022-29458,GHSA-8v99-48m9-c8pm,GHSA-c3xm-pvg7-gh7r,GHSA-crp2-qrr5-8pq7,GHSA-fgv8-vj5c-2ppq,GHSA-q3j5-32m5-58c2' sut
